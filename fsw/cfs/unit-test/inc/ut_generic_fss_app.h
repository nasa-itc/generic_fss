 ...
 *
 * Purpose:
 * Extra scaffolding functions for the generic_fss_app unit test
 *
 * Notes:
 ...
 */
 ...
 #ifndef UT_GENERIC_FSS_APP_H
 #define UT_GENERIC_FSS_APP_H
 
 /*
  * Necessary to include these here to get the definition of the
  * "GENERIC_FSS_APP_Data_t" typedef.
  */
 #include "generic_fss_app.h"
 
 /*
  * Allow UT access to the global "GENERIC_FSS_APP_Data" object.
  */
 // extern GENERIC_FSS_AppData_t GENERIC_FSS_APP_Data;
 
 #endif /* UT_GENERIC_FSS_APP_H */
